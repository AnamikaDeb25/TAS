...
public class EditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager =  new LinearLayoutManager(EditProfile.this);
        ...
        img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EditProfile.this,ImageViewofprofilepic.class);
    ...
    private boolean checkStoragePermission(){
        boolean resul = ContextCompat.checkSelfPermission(EditProfile.this,Manifest.permission.WRITE_EXTERNAL_STORAGE)
                == (PackageManager.PERMISSION_GRANTED);
        return resul;
    }
    private void requestStoragePermission(){
        ActivityCompat.requestPermissions(EditProfile.this,StoragePermissions,STORAGE_REQUEST_CODE);
    }
    private boolean checkCameraPermission(){
        boolean resul = ContextCompat.checkSelfPermission(EditProfile.this,Manifest.permission.CAMERA)
                == (PackageManager.PERMISSION_GRANTED);
        boolean resul1 = ContextCompat.checkSelfPermission(EditProfile.this,Manifest.permission.WRITE_EXTERNAL_STORAGE)
                == (PackageManager.PERMISSION_GRANTED);
        return resul && resul1;
    }
    private void requestCameraPermission(){
        ActivityCompat.requestPermissions(EditProfile.this,cameraPermissions,CAMERA_REQUEST_CODE);
    }
...
private void showditProfile(){
            ...
            if (userprofile != null){
                ...
                if (Phnn.equals(" ")){
                    ...
                    phn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            startActivity(new Intent(EditProfile.this,OtpVerificationteachers.class));
                        }
                    });
                }
            }
    ...
    editschool.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            pd.setMessage("Updating School name");
            ...
            ss.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    pd.show();
                    String value = Schoolname.getText().toString().trim();
                    if (value.isEmpty()){
                        ...
                        DatabaseReference firebaseDatabase =   FirebaseDatabase.getInstance().getReference("User").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                        firebaseDatabase.child("school").setValue(value);
                        pd.dismiss();
                        Toast.makeText(EditProfile.this,"Updated",Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!TextUtils.isEmpty(value)){
                    ...
                    pd.dismiss();
                    Toast.makeText(EditProfile.this,"Please enter "+key,Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            case CAMERA_REQUEST_CODE:{
                if (grantResults.length > 0){
                    ...
                    if (cameraAccepted && writeStorageAccepted){
                        ...
                        //permission denied
                        Toast.makeText(EditProfile.this,"Please enable camera & Storage Permission",Toast.LENGTH_LONG).show();
                    }
                }
            ...
            case STORAGE_REQUEST_CODE:{
                if (grantResults.length > 0){
                    ...
                    if (writeStorageAccepted){
                        ...
                        //permission denied
                        Toast.makeText(EditProfile.this,"Please enable Storage Permission",Toast.LENGTH_LONG).show();
                    }
                }
            }
            break;
    ...
    private void pickFromCamera() {
        ...
        //put image uri
        image_uri = EditProfile.this.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,values);
        ...
        FirebaseRecyclerAdapter<PostMember, AdapterPost> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<PostMember, AdapterPost>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdapterPost holder, int position, @NonNull final PostMember model) {
                        ...
                        holder.SetPost(EditProfile.this,model.getName(),model.getUrl(),model.getPostUri(),model.getTime(),model.getUid(),model.getType(),model.getDesc());
...
//
                        if (type.equals("iv")){
                            holder.iv_post.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent intent = new Intent(EditProfile.this,ImageviewForPostpic.class);
...
//                                                sendNotification(userid,name_result);
                        ...
                        holder.commentbtn.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent = new Intent(EditProfile.this,CommentsActivity.class);
            ...
            public void onClick(View view) {
                PermissionListener permissionListener = new PermissionListener() {
                    ...
                    public void onPermissionGranted() {
                        ...
                        DownloadManager manager = (DownloadManager)EditProfile.this.getSystemService(Context.DOWNLOAD_SERVICE);
                        manager.enqueue(request);
                        Toast.makeText(EditProfile.this, "Downloading", Toast.LENGTH_SHORT).show();

                    }

                    @Override
                    public void onPermissionDenied(List<String> deniedPermissions) {
                        Toast.makeText(EditProfile.this,"No Permissions",Toast.LENGTH_SHORT).show();
                    }
                };
                TedPermission.with(EditProfile.this).setPermissionListener(permissionListener).setPermissions(Manifest.permission.INTERNET,Manifest.permission.READ_EXTERNAL_STORAGE).check();
            }
        });
            ...
            public void run() {
                ...
                FcmNotificationSender notificationsSender =
                        new FcmNotificationSender(usertoken,"TAS",name_result+" Liked Your post ",
                                getApplicationContext(),EditProfile.this);
