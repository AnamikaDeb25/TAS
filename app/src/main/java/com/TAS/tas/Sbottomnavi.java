...
public class Sbottomnavi extends AppCompatActivity {
    String mUID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sbottomnavi);
                ...
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(Sbottomnavi.this, "Token is missing", Toast.LENGTH_SHORT).show();
                            return;
                        }
        ...
        bottomNavigation = findViewById(R.id.meoww);
